...
<body>
    <div class="container">
        ...
        if (isset($_SESSION['form_errors'])) {
            echo '<div class="error-message"><strong>Ошибки заполнения:</strong><ul>';
        ...
        if (isset($_SESSION['form_success'])) {
            echo '<div class="success-message">' . htmlspecialchars($_SESSION['form_success']) . '</div>';
        ...
        <form action="save_form.php" method="POST">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <input type="radio" id="male" name="gender" value="male" 
                            <?php echo (isset($_SESSION['form_data']['gender']) && $_SESSION['form_data']['gender'] == 'male') ? 'checked' : ''; ?> required>
                    ...
                    <div class="radio-option">
                        <input type="radio" id="other" name="gender" value="other"
                            <?php echo (isset($_SESSION['form_data']['gender']) && $_SESSION['form_data']['gender'] == 'other') ? 'checked' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <select id="languages" name="languages[]" multiple required>
                    ...
                    $selected_langs = isset($_SESSION['form_data']['languages']) ? $_SESSION['form_data']['languages'] : [];
            ...
            <div class="form-group">
                <div class="checkbox-group">
                    <input type="checkbox" id="contract" name="contract_accepted" value="1" 
                        <?php echo (isset($_SESSION['form_data']['contract_accepted']) && $_SESSION['form_data']['contract_accepted'] == '1') ? 'checked' : ''; ?> required>
