...
<body>
    <div class="admin-container">
                ...
                <form action="admin.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="languages[]" multiple size="6">
                            <?php
                            $all_langs = ['Pascal', 'C', 'C++', 'JavaScript', 'PHP', 'Python', 
                                         'Java', 'Haskell', 'Clojure', 'Prolog', 'Scala', 'Go'];
                            foreach ($all_langs as $lang):
                                $selected = in_array($lang, $edit_user['languages'] ?? []) ? 'selected' : '';
                            ?>
        ...
        <?php if (empty($users)): ?>
            <p style="text-align: center; padding: 20px;">Нет зарегистрированных пользователей</p>
        <?php endif; ?>
    </div>
</body>
</html>
